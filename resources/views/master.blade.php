...
<head>
    ...
    <title> EGames - @yield('title') </title>
   ...
   <link rel="stylesheet" type="text/css" href="{{URL::asset('backend/helpers/colors.css')}}">
    ...
    <script>tinymce.init({ selector:'.texteditor',
            ...
            external_filemanager_path:"{{URL::asset('backend/filemanager/')}}",
            external_plugins: { "filemanager" : "{{URL::asset('backend/filemanager/plugin.min.js')}}"},
            ...
            <div id="header-nav-left">
                ...
                <div class="user-account-btn dropdown">
                    <a href="#" title="My Account" class="user-profile clearfix" data-toggle="dropdown">
                        <img width="28" src="{{URL::asset('backend/image-resources/user.png')}}" alt="Profile image'">
                        <?php if(!Auth::user()) return redirect('/admin') ?>
                    ...
                    <div class="dropdown-menu float-left">
                        <div class="box-sm">
                            ...
                            <div class="pad5A button-pane button-pane-alt text-center">
                                <a href="{{URL::to('/admin')}}" class="btn display-block font-normal btn-danger">
